...
function classService($http, $q) {
    ...
    function getTemporaryClasses() {
        return [
            ...
            { name: "*Cardio & Conditioning (BEG)", description: "Our Cardio & Conditioning class is great for some off the pole strength training! We will incorporate more traditional exercises that will help make you stronger so you can knock out your aerial goals even faster! *Drop Ins Welcome", teacher: "", startTime: "", duration: "" },
            ...
            { name: "Multi-Level Choreography (BEG/INT)", description: "Our Multi-level choreography class is a great class for students looking for a fresh new dance routine each week! We will provide dance instruction to a variety of dance and music styles to keep the class fun and exciting. This is a beginner level class with modifications for more advanced students. Our ML Choreography class is like our intro to pole class- but BETTER with longer routines and spins and tricks that are incorporated in the routine! ", teacher: "", startTime: "", duration: "" },
